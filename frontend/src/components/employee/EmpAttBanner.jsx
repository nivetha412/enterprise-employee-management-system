    ...
    <div className="fade-in" style={{
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: "20px", position: "relative" }}>
        <div style={{ display: "flex", alignItems: "flex-start", gap: "18px" }}>
          <div style={{ width: "60px", height: "60px", borderRadius: "16px", background: "linear-gradient(135deg,#60a5fa,#a78bfa)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "20px", fontWeight: 800, color: "#fff", border: "2.5px solid rgba(255,255,255,0.25)", boxShadow: "0 8px 24px rgba(0,0,0,0.25)", flexShrink: 0 }}>
            {initials}
          </div>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
              <span style={{ fontSize: "18px" }}>{emoji}</span>
              <h1 style={{ fontSize: "19px", fontWeight: 800, color: "#fff", margin: 0 }}>{text}, {displayName}!</h1>
            </div>
            <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "12px", marginBottom: "12px" }}><LiveClock /></p>
            <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", alignItems: "center" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "6px", background: statusCfg.bg, border: `1px solid ${statusCfg.border}`, borderRadius: "10px", padding: "5px 12px" }}>
              ...
              {checkedIn && (
                <div style={{ background: "rgba(255,255,255,0.08)", borderRadius: "10px", padding: "5px 12px", border: "1px solid rgba(255,255,255,0.12)" }}>
                  <span style={{ fontSize: "11px", color: "rgba(255,255,255,0.5)" }}>In: </span>
                  <span style={{ fontSize: "12px", fontWeight: 700, color: "#86efac" }}>{todayRecord.checkInTime}</span>
                </div>
              )}
              {checkedOut && (
                <div style={{ background: "rgba(255,255,255,0.08)", borderRadius: "10px", padding: "5px 12px", border: "1px solid rgba(255,255,255,0.12)" }}>
                  <span style={{ fontSize: "11px", color: "rgba(255,255,255,0.5)" }}>Out: </span>
        ...
        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
          <button onClick={onCheckIn} disabled={loading || checkedIn} style={{
            ...
            <RiLoginBoxLine size={16} /> {loading ? "…" : "Check In"}
          </button>
          <button onClick={onCheckOut} disabled={loading || !checkedIn || checkedOut} style={{
            display: "flex", alignItems: "center", gap: "8px", padding: "11px 22px",
            borderRadius: "12px", border: "none", fontWeight: 700, fontSize: "13px",
            ...
            onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; }}>
            <RiLogoutBoxLine size={16} /> {loading ? "…" : "Check Out"}
          </button>
        </div>
      </div>
    </div>
